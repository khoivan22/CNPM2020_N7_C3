                            ...
                            <div class="sidebar_main_content_area">
                                ...
                                <div class="main_slider_area">
                                    <div id="home_box_slider" class="rev_slider" data-version="5.3.1.6">
                                        <ul>
                                            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="<%=Util.fullPath("img/home-slider/slider-1.jpg")%>" style="width: 400px" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                            <!-- MAIN IMAGE -->
                                            <img src="<%=Util.fullPath("img/home-slider/slider-1.jpg")%>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>

                                            </li>
                                            <li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="<%=Util.fullPath("img/home-slider/slider-1.jpg")%>" style="width: 400px" data-rotate="0"  data-saveperformance="off"  data-title="Creative" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                            <!-- MAIN IMAGE -->
                                            <img src="<%=Util.fullPath("img/home-slider/slider-2.jpg")%>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                                    ...
                                    <div class="feature_inner row m0">
                                        <div class="left_promotion">
                                            <div class="f_add_item">
                                                <div class="f_add_img"><img class="img-fluid" src="<%=Util.fullPath("img/feature-add/f-add-6.jpg")%>" alt=""></div>
                                        ...
                                        <div class="right_promotion">
                                            <div class="f_add_item right_dir">
                                                <div class="f_add_img"><img class="img-fluid" src="<%=Util.fullPath("img/feature-add/f-add-7.jpg")%>" alt=""></div>
                                                <div class="f_add_hover">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="item woman shoes">
                                            ...
                                            <div class="l_product_item">
                                                ...
                                                <div class="l_p_text">
                                                    ...
                                                    <h5><del><%=Util.convertPrice(rs.getDouble(2))%></del> </br> <%=Util.convertPrice(rs.getDouble(2) - rs.getDouble(7))%></h5>
                                                </div>
                                            </div>
                                            <%
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="<%=Util.fullPath("img/blog/from-blog/f-blog-4.jpg")%>" alt="">
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="<%=Util.fullPath("img/blog/from-blog/f-blog-5.jpg")%>" alt="">
                                                <div class="f_blog_text">
                                                    <h5>fashion</h5>
                                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                                    <h6>21.09.2017</h6>
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="from_blog_item">
                                                <img class="img-fluid" src="<%=Util.fullPath("img/blog/from-blog/f-blog-6.jpg")%>" alt="">
                                                <div class="f_blog_text">
                                                    <h5>fashion</h5>
                                                    <p>Neque porro quisquam est qui dolorem ipsum</p>
                                                    <h6>21.09.2017</h6>
                                    ...
                                    <div class="verticalCarousel">
                                        ...
                                        <ul class="verticalCarouselGroup vc_list ">
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="<%=Util.fullPath("img/product/featured-product/f-p-1.jpg")%>" alt="">
                                                    </div>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="<%=Util.fullPath("img/product/featured-product/f-p-2.jpg")%>" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>Puffer Jacket</h4>
                                                        <h5>$45.05</h5>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="<%=Util.fullPath("img/product/featured-product/f-p-3.jpg")%>" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>Leather Bag</h4>
                                                        <h5>$45.05</h5>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <img src="<%=Util.fullPath("img/product/featured-product/f-p-4.jpg")%>" alt="">
                                                    </div>
                                                    <div class="media-body">
                                                        <h4>Casual Shoes</h4>
                                                        <h5>$45.05</h5>
