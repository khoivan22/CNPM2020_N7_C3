...
public class detail_product extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement stProduct = Database.getPreparedStatement(product);
            ...
            PreparedStatement stConf = Database.getPreparedStatement(conf);
            ...
            PreparedStatement stCom = Database.getPreparedStatement(com);
            ...
            if (us != null) {
                ...
                stCom = Database.getPreparedStatement(sql);
                stCom.setString(1, detail);
